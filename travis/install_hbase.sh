...
if [ ! -f $HOME/download/hbase-1.2.4-bin.tar.gz ]; then sudo wget -O $HOME/download/hbase-1.2.4-bin.tar.gz http://www-eu.apache.org/dist/hbase/1.2.4/hbase-1.2.4-bin.tar.gz; fi
