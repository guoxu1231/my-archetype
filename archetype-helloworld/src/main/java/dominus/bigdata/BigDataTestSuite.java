...
import dominus.intg.jms.kafka09.KafkaProducerTestcase;
import org.junit.runner.RunWith;
import org.junit.runners.Suite;

//EE: Aggregating tests in suites
@RunWith(Suite.class)
@Suite.SuiteClasses({HdfsClientTest.class, OozieActionTest.class, SqoopConnectorTest.class, KafkaProducerTestcase.class})
