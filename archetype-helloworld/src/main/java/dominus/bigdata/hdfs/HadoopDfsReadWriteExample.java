...
//            copyWrite(fs, "/user/hive/warehouse/src_customer_aa/part-00001", "/user/shawguo/data/part-00001-copy");
            fileBlockLocation(fs, "/user/shawguo/data/SalesLog/sales1.dat");
//            fileCheckSum(fs, "/user/akshukla/custbug/sales1.dat");
//            fileCheckSum(fs, "/user/akshukla/custbug/sales10.dat");
     ...
     * @param fs
     */
    public static void fileBlockLocation(FileSystem fs, String path) throws IOException {
    ...
    public static void fileCheckSum(FileSystem fs, String path) throws IOException {

        FileChecksum md51 = fs.getFileChecksum(new Path(path));
        System.out.println(md51.hashCode());
    }
