...
package dominus.bigdata.yarn.unmanagedamlauncher;
 ...
 *
 * TODO:
 * 1, YARN_CONF_DIR not work;
 * 2, UnmanagedAM FinalStatus:	UNDEFINED
 *
 *
 *
 */
public class UnmanagedAMLauncher {
    ...
    private static final long AM_STATE_WAIT_TIMEOUT_MS = 100000;
    ...
    public UnmanagedAMLauncher(Configuration conf) throws Exception {
        // Set up RPC
        this.conf = conf;
        this.conf.addResource("yarn-clientconfig-cdh/core-site.xml");
        this.conf.addResource("yarn-clientconfig-cdh/yarn-site.xml");
    }
