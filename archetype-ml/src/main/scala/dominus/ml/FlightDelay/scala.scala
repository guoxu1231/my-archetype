package dominus.ml.FlightDelay
...
//EE:https://www.mapr.com/blog/apache-spark-machine-learning-tutorial
object FlightDelay {
  ...
  def main(args: Array[String]) {
    ...
    val textRDD = sc.textFile("/opt/Development/github_repo/my-archetype/archetype-ml/data/rita2014jan.csv")
